    ...
    <div className='fixed w-full h-22 flex z-1000 backdrop-blur-md inset-0'>
      {
        ...
        <div className='h-full w-[20%] flex justify-center items-center gap-2 md:gap-4'>
          ...
          <div className='rounded-full w-9 h-9 justify-center items-center flex shadow-[0px_0px_27px_0px_rgba(0,_0,_0,_0.1)] bg-gray-200'><IoCartOutline className='w-4 h-4' /></div>
          <p className='text-[14px] text-black'>{cartValue ? '('+ cartValue +')' : '' }</p>
          </Link>

          <div>
          <Link href='/Cart/trackorder' className='transition-transform active:scale-95 duration-100 rounded-full w-9 h-9 justify-center items-center flex shadow-[0px_0px_27px_0px_rgba(0,_0,_0,_0.1)] bg-gray-200'><PiMapPinAreaLight className='w-4 h-4' /></Link>
        </div>
        </div>

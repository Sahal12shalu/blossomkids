...
function FocusCardsDemo() {
  ...
  return (
    <div className="bg-white w-full">
        ...
        <div
          className="grid grid-cols-1 md:grid-cols-3 gap-2 md:gap-15 max-sm:flex md:max-w-5xl md:px-8 w-full mx-auto max-md:px-3 mt-2 mb-5 md:mt-4 md:mb-8">
            <Link href={`/Category/Categorypage/${'bags'}`} className="flex flex-col w-full hover:scale-105 transform transition-transform duration-300">
              <div className="rounded-lg relative overflow-hidden h-40 md:h-90 md:w-70 w-full transition-all duration-300 ease-out shadow-[0px_0px_20px_0px_rgba(0,_0,_0,_0.1)]">
                <Image src='/all/bag.jpg' alt='bag' width={300} height={300} className="object-cover w-full h-full inset-0" />
              </div>
              </Link>
              ...
              <div className="rounded-lg relative  overflow-hidden h-40 md:h-90 md:w-70 w-full transition-all duration-300 ease-out shadow-[0px_0px_20px_0px_rgba(0,_0,_0,_0.1)]">
                <Image src='/all/bottle.webp' alt='bottle' width={300} height={300} className="object-cover w-full h-full inset-0" />
              </div>
              </Link>
              ...
              <div className="rounded-lg relative overflow-hidden h-40 md:h-90 md:w-70 w-full transition-all duration-300 ease-out shadow-[0px_0px_20px_0px_rgba(0,_0,_0,_0.1)]">
                <Image src='/all/teddy.webp' alt='teddy' width={300} height={300} className="object-cover w-full h-full inset-0" />
              </div>
              </Link>
        </div>
        </div>

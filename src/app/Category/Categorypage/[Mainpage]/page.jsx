            ...
            <div className='max-w-6xl px-2 md:px-5 flex flex-wrap justify-center items-center gap-3 md:gap-10'>
              {
                data.map((value, index) => (
                  <Link href={`/Category/Productshow/${value._id}`} key={value._id + '-' + value.quantity} className={`w-42 md:w-60 h-70 md:h-82 shadow-[0px_1px_29px_10px_rgba(0,_0,_0,_0.1)] relative hover:scale-105 transform transition-transform duration-300  rounded-md md:p-3 pb-9 bg-white`}>
